...
myFont :: String
myFont = "xft:DankMono Nerd Font Mono:regular:size=9:antialias=true:hinting=true"
...
myNormColor   = "#2b3339"   -- This variable is imported from Colors.THEME

myFocusColor :: String      -- Border color of focused windows
myFocusColor  = "#a7c080"    -- This variable is imported from Colors.THEME
...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
                ...
                , NS "gnome-calculator" spawnCalc findCalc manageCalc
                ]
  where
...
myManageHook = composeAll
     ...
     , className =? "torbrowser-launcher"       --> doShift ( myWorkspaces !! 1 )
     , className =? "VirtualBox Manager"        --> doShift  ( myWorkspaces !! 4 )
     , className =? "nautilus"        --> doShift ( myWorkspaces !! 2 )
     , className =? "mpv"             --> doShift ( myWorkspaces !! 7 )
     , className =? "vlc"             --> doShift ( myWorkspaces !! 7 )
     , className =? "gnome-music"     --> doShift ( myWorkspaces !! 7 )
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              { ppOutput = \x -> hPutStrLn xmproc0 x   -- xmobar on monitor 1
                ...
                -- Current workspace
              , ppCurrent = xmobarColor "#d699b6" "" . wrap
                            "<box type=Bottom width=2 mb=2 color=#d699b6>" "</box>"
                -- Visible but not current workspace
              , ppVisible = xmobarColor color06 "" . clickable
                -- Hidden workspace
              , ppHidden = xmobarColor "#7fbbb3" "" . wrap
                           ("<box type=Top width=2 mt=2 color=#7fbbb3>") "</box>" . clickable
                -- Hidden workspaces (no windows)
              , ppHiddenNoWindows = xmobarColor "#dbbc7f" ""  . clickable
                -- Title of active window
              , ppTitle = xmobarColor "#d3c6aa" "" . shorten 60
                -- Separator character
              , ppSep =  "<fc=#666> <fn=1>|</fn> </fc>"
                -- Urgent workspace
